...
import (
	...
	v1 "assignment-tugas-golang/aggregator/proto/aggregator_service/v1"
	"context"
	"fmt"
...
func NewAggregatorService(user_Service v1.UserServiceClient, wallet_Service v1.WalletServiceClient, transaction_Service v1.TransactionServiceClient) IAggregatorService {
	return &aggrService{
...
func (g *aggrService) CreateUser(ctx context.Context, user *entity.User) (entity.User, error) {
...
func (g *aggrService) GetUserByID(ctx context.Context, id int) (entity.User, error) {
...
func (g *aggrService) UpdateUser(ctx context.Context, id int, user entity.User) (entity.User, error) {
...
func (g *aggrService) DeleteUser(ctx context.Context, id int) error {
...
func (g *aggrService) GetAllUsers(ctx context.Context) ([]entity.User, error) {
...
func (g *aggrService) CreateWallet(ctx context.Context, wallet *entity.Wallet) (entity.Wallet, error) {
...
func (g *aggrService) GetWalletByID(ctx context.Context, id int) (entity.Wallet, error) {
...
func (g *aggrService) UpdateWallet(ctx context.Context, id int, wallet entity.Wallet) (entity.Wallet, error) {
...
func (g *aggrService) DeleteWallet(ctx context.Context, id int) error {
...
func (g *aggrService) GetAllWallets(ctx context.Context) ([]entity.Wallet, error) {
...
func (g *aggrService) GetTransactionByWalletID(ctx context.Context, walletID int) ([]entity.TransactionResponse, error) {
...
func (g *aggrService) CreateTransaction(ctx context.Context, transaction *entity.Transaction) (entity.Transaction, error) {
...
func (g *aggrService) GetTransactionByID(ctx context.Context, id int) (entity.Transaction, error) {
...
func (g *aggrService) DeleteTransaction(ctx context.Context, id int) error {
